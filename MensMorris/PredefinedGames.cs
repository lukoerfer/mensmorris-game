...
namespace MensMorris.Game
{
    public static class PredefinedGames
    {
        public static Dictionary<string, Settings> GetGames()
        {
            ...
            rules.Add("Nine Mens Morris", new Settings(3, false, false, 9));
            rules.Add("Nine Holes", new Settings(1, true, true, 3));
            rules.Add("Six Mens Morris", new Settings(2, false, false, 6));
            return rules;
        }
